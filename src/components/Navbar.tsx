...
export default function Navbar() {
  ...
  return (
    <nav
      className="fixed top-0 left-0 right-0 z-50 px-4 md:px-8 py-3 border-b border-gold/15 overflow-hidden"
      style={{
        background: "linear-gradient(270deg, rgba(10,10,10,0.88), rgba(20,14,2,0.92), rgba(10,10,10,0.88), rgba(15,10,1,0.90))",
    ...
    >
      ...
      <div
        ...
        style={{
          background: "linear-gradient(90deg, transparent, rgba(234,179,8,0.15), rgba(234,179,8,0.8), rgba(255,200,50,1), rgba(234,179,8,0.8), rgba(234,179,8,0.15), transparent)",
          animation: "navbarBar 4s ease-in-out infinite",
        }}
      />
